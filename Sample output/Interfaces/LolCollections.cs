...
namespace LCU_API_Generator
{
    public static class LolCollections
    {
        ...
        public static Task<LolCollectionsCollectionsTopChampionMasteries> GetLolCollectionsV1InventoriesBySummonerIdChampionMasteryTop([Parameter("summonerId", "path")] long summonerId, [Parameter("limit", "query")] long limit, [Parameter("sortRule", "query")] string sortRule)
            => Sender.Request<LolCollectionsCollectionsTopChampionMasteries>("get", $"/lol-collections/v1/inventories/{summonerId}/champion-mastery/top?limit={System.Net.WebUtility.UrlEncode(limit.ToString())}&sortRule={System.Net.WebUtility.UrlEncode(sortRule.ToString())}");
