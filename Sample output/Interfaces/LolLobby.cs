...
namespace LCU_API_Generator
{
    public static class LolLobby
    {
        ...
        public static Task<object> PostLolLobbyV1LobbyCustomSwitchTeams([Parameter("team", "query")] string team)
            => Sender.Request<object>("post", $"/lol-lobby/v1/lobby/custom/switch-teams?team={System.Net.WebUtility.UrlEncode(team.ToString())}");
