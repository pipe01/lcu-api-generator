...
namespace LCU_API_Generator
{
    public static class LolSummoner
    {
        ...
        public static Task<LolSummonerSummoner[]> GetLolSummonerV2Summoners([Parameter("name", "query")] string name, [Parameter("ids", "query")] long[] ids)
            => Sender.Request<LolSummonerSummoner[]>("get", $"/lol-summoner/v2/summoners?name={System.Net.WebUtility.UrlEncode(name.ToString())}&ids={System.Net.WebUtility.UrlEncode(ids.ToString())}");
    }
}
