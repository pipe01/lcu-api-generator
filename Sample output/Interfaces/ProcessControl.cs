...
namespace LCU_API_Generator
{
    public static class ProcessControl
    {
        ...
        /// </summary>
        public static Task PostProcessControlV1ProcessRestart([Parameter("delaySeconds", "query")] int delaySeconds, [Parameter("restartVersion", "query")] int restartVersion)
            => Sender.Request("post", $"/process-control/v1/process/restart?delaySeconds={System.Net.WebUtility.UrlEncode(delaySeconds.ToString())}&restartVersion={System.Net.WebUtility.UrlEncode(restartVersion.ToString())}");
        /// <summary>
