...
namespace LCU_API_Generator
{
    ...
    public class EndOfGameLcdsEndOfGameStats
    {
        ...
        public EndOfGameLcdsSpell[] NewSpells { get; set; }
        [JsonProperty("odinBonusIp")]
        public int OdinBonusIp { get; set; }
        [JsonProperty("otherTeamInfo")]
        public EndOfGameLcdsTeamInfo OtherTeamInfo { get; set; }
        [JsonProperty("otherTeamPlayerParticipantStats")]
        public EndOfGameLcdsPlayerParticipantStatsSummary[] OtherTeamPlayerParticipantStats { get; set; }
        [JsonProperty("partyRewardsBonusIpEarned")]
        public int PartyRewardsBonusIpEarned { get; set; }
        [JsonProperty("pointsPenalties")]
        public EndOfGameLcdsPointsPenalty[] PointsPenalties { get; set; }
        ...
        [JsonProperty("teamPlayerParticipantStats")]
        public EndOfGameLcdsPlayerParticipantStatsSummary[] TeamPlayerParticipantStats { get; set; }
